...
@dataclass
class EnsembleConfig(PeftConfig):
    """
    This is the configuration class to store the configuration of a :class:`~peft.tuners.EnsembleModel`.

    Args:
        target_modules (`Optional[Union[List[str], str]]`):
            List of module names or regex expression of the module names to replace with Ensemble. For example,
    ...
    target_modules: Optional[Union[list[str], str]] = field(
        ...
        metadata={
            "help": (
                "List of module names or regex expression of the module names to replace with Ensemble."
    ...
    def __post_init__(self):
        self.peft_type = PeftType.ENSEMBLE
